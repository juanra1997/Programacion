...
/********************************************************************************************************
 * Clase principal. Engloba todos los metodos con los que funciona el programa
 * @author Juanra
 * @version 0.1Beta
 ********************************************************************************************************/
public class ClaseHundirFlota {
	...
	/********************************************************************************************************
	 * Variables que definen tanto el ancho del tablero como la cantidad de barcos disponibles.
	 * @author Juanra
	 ********************************************************************************************************/
	 ...
	 * @param args: parametro basico del main
	 *******************************************************************************************************/
	 ...
	 * @author Juanra
	 *@version 0.1Beta
	 *@see PreacticaED.ClaseHundirFLota 
	 **********************************************************************************************/
	
	/********************************************************************************************************
	 * Función destinada a dibujar los paneles del usuario.
	 * @author Juanra
	 * @param matrizUsuario, barcosUsuario, barcosMaquina
	 ********************************************************************************************************/
	 ...
	 * @author Juanra
	 * @param matrizUsuario, matrizMaquina, barcos
	 ********************************************************************************************************/
	 ...
	 * @author Juanra
	 * @param tamanhoBarco
	 * @return valoresBarco: retorna un array con las posiciones en las que se encuentra el barco
	 */
	 ...
	 * @author Juanra
	 * @param cadenaMensaje
	 * @return valores: retorna los valores en los que se ha "Disparado"
	 ********************************************************************************************************/
	 ...
	 * @author Juanra
	 * @param matriz, fila, columna, posicion, tamanho, valorBarco
	 ********************************************************************************************************/
	 ...
	 * @author Juanra
	 * @return valores: retorna los valores en los que se va a colocar un barco
	 */
	 ...
	 * @author Juanra
	 * @param barcos
	 * @return true or false, según si ha acabado o no la partida
	 ********************************************************************************************************/
	 ...
	 * @author Juanra
	 * @param fila, columna
	 * @return true or false, segun si la casilla indicada es o no erronea
	 ********************************************************************************************************/
	 ...
	 * @author Juanra
	 * @param fila, columna, posicion, tamanho, matriz
	 * @return true or false, segun si el barco se encuentra en las casillas existentes o no
	 ********************************************************************************************************/
	 ...
	 * @author Juanra
	 * @param valores, matriz
	 * @return true or false, segun si la casilla existe o no y si la casilla ya ha sido señalada o no
	 ********************************************************************************************************/
	 ...
	 * @author Juanra
	 * @return matriz: retorna un tablero vacio
	 ********************************************************************************************************/
	 ...
	 * @author Juanra
	 * @return tablaBarcos: retorna una tabla indicando las posiciones de los barcos que hay
	 ********************************************************************************************************/
	 ...
	 * @author Juanra
	 * @param numCaracteres: variable para usar los caracteres
	 * @return resultado: array en el que se muestra el resultado
	 ********************************************************************************************************/
